...
https://www.youtube.com/watch?v=SGrDbZxZeuw
...
Update: after filming the video, I asked
our [GrizzledSeniorDev](https://github.com/scorbo2/ai-playground/blob/master/agents/GrizzledSeniorDev.md)
code review agent to take a look at the results and rank them. The results were a bit
surprising: [ResultsComparison.md](ResultsComparison.md)
